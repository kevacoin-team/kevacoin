...
- Builders use Gitian to create an unsigned release. This outputs an unsigned
  ...
  structure in the form of a tarball.
- The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/kevacoin-team/kevacoin-detached-sigs).
