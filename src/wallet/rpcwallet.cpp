...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nReturns a new Kevacoin address for receiving payments.\n"
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nDEPRECATED. Returns the current Kevacoin address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account kevacoin address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new Kevacoin address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", \"tabby\"")
        );
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Kevacoin address");
    }
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The kevacoin address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\"")
            + HelpExampleRpc("getaccount", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\"")
        );
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a kevacoin address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The kevacoin address to send to.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The kevacoin address\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The kevacoin address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The kevacoin address for transactions.\n"
            "2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount   (numeric) The total amount in " + CURRENCY_UNIT + " received at this address.\n"
            "\nExamples:\n"
            "\nThe amount from transactions with at least 1 confirmation\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0") +
            "\nThe amount with at least 6 confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a kevacoin address."
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The kevacoin address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The kevacoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"VPV6zKqt3gBufa1V4jdPc9WMuHz6GYufTS\\\":0.01,\\\"VCGLU9RdqoQaFo19SziUzeke9pcDBomU2X\\\":0.02}\" 1 \"\" \"[\\\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\\\",\\\"LbhhnrHHVFP1eUjP1tdNIYeEVsNHfN9FCw\\\"]\"") +
            "\nAs a json rpc call\n"
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4) {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" \"address_type\" )\n"
            ...
            "Each key is a Kevacoin address or hex-encoded public key.\n"
            ...
            "2. \"keys\"                         (string, required) A json array of kevacoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"                  (string) kevacoin address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\\\",\\\"LYKr1oaPSqShthukmLDhdZsqUJgzVnQiAQ\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\\\",\\\"LYKr1oaPSqShthukmLDhdZsqUJgzVnQiAQ\\\"]\"")
        ;
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The kevacoin address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The kevacoin address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The kevacoin address involved in the transaction\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending kevacoin\n"
    ...
    StartShutdown();
    return "wallet encrypted; Kevacoin server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of kevacoin addresses to filter\n"
            "    [\n"
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Kevacoin address: ") + input.get_str());
            }
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The kevacoin address to receive the change\n"
    ...
    if (!request.params[1].isNull()) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid kevacoin address");
            }
...
extern UniValue keva_group_leave(const JSONRPCRequest& request);
...
{ //  category              name                        actor (function)           argNames
    ...
    { "kevacoin",           "keva_group_leave",         &keva_group_leave,         {"my_namespace", "other_namespace"} }
};
